...
internal class PersonServiceTest {
    ...
    fun findAll() {
        ...
        assertEquals("Address Test1",personOne.adress)
        ...
        assertEquals("Address Test4",personFour.adress)
        ...
        assertEquals("Address Test7",personSeven.adress)
    ...
    fun findById() {
        ...
        assertEquals("Address Test1",result.adress)
